...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: sushi, text: "Sushi" },
      { image: pizza, text: "Pizza" },
      { image: burger, text: "Burger" },
      { image: pasta, text: "Pasta" },
      { image: salad, text: "Salad" },
      { image: dessert, text: "Dessert" },
      { image: drinks, text: "Drinks" },
      { image: lunch, text: "Lunch" },
      { image: buffet, text: "Buffet" },
      // { image: appetizers, text: "Appetizers" },
    //   { image: asian, text: "Asian" },
