...
const Footer = () => {
  return (
    <footer className="bg-blue-100 border-t border-gray-200 w-full">
      <div className="px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className='hidden md:flex flex-col gap-2'>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">FoodExpress</h3>
            <p className="text-gray-600 text-sm">
              Delivering happiness to your doorstep with the best food from your favorite restaurants.
            </p>
          </div>    
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/restaurants" className="text-gray-600 hover:text-blue-600 text-sm">
                  Restaurants
                </Link>
              </li>
              <li>
